...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      verify(
        () => bloc.add(AddressNameChanged(addressName.capitalizeFirstLetter())),
      ).called(1);
      verify(
        () => bloc.add(
          AddressDetailNoteChanged(addressDetail.capitalizeFirstLetter()),
        ),
      ).called(1);
      verify(
        () => bloc
            .add(RecipientNameChanged(recipientName.capitalizeFirstLetter())),
      ).called(1);
