...
class OrderModel extends Equatable {
  ...
  factory OrderModel.fromOrderAndPaymentInfo(
    ...
    return OrderModel(
      ...
      orderDate: order.orderDate.toDateTime().toLocal(),
      productsBought: order.items.map(OrderProductModel.fromPb).toList(),
      paymentExpiryTime: order.paymentExpiryTime.toDateTime().toLocal(),
      estimatedArrivalTime: order.estimatedDeliveryTime.toDateTime().toLocal(),
      orderCompletionTime: order.orderCompletedTime.toDateTime().toLocal(),
      recipientAddress:
